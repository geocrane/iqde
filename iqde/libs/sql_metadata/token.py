...
import iqde.data.sqlparse.sql
from iqde.data.sqlparse.tokens import Comment, Name, Number, Punctuation, Wildcard, Keyword
...
class SQLToken:  # pylint: disable=R0902, R0904
    ...
    def __init__(
        self,
        tok: iqde.data.sqlparse.sql.Token = None,
        index: int = -1,
